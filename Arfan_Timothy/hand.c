...
/* this method calculates hand value and
 prints results of hand by sorting the hand */
void best_hand(Hand * hand, int isFinalRound, int isCPU){
    ...
    oneS   = hand->card[0].suite;
    oneV = hand->card[0].value;
    twoS   = hand->card[1].suite;
    twoV = hand->card[1].value;
    threeS = hand->card[2].suite;
    threeV = hand->card[2].value;
    fourS  = hand->card[3].suite;
    fourV = hand->card[3].value;
    fiveS  = hand->card[4].suite;
    fiveV = hand->card[4].value;
