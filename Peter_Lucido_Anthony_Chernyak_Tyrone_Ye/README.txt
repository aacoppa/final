...
2) If you want to to engage in online mode you need to run both Verify and ToSave in seperate terminals. 
...
4) If for whatever reason you do not wish to run the game online, you can simply run the 'execute' executable, though OSave and OLoad will not be functional.
